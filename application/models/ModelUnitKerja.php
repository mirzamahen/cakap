...
class ModelUnitKerja extends CI_Model {
	...
	var $column_order = array(null,'kode_unit','nama_unit_kerja','profil_unit','status_unit',null); 
	var $column_search = array('kode_unit','nama_unit_kerja'); 
